package net.huray.basiccodelab.data.interests.impl
...
import net.huray.basiccodelab.data.interests.InterestSection
import net.huray.basiccodelab.data.interests.InterestsRepository
import net.huray.basiccodelab.data.interests.TopicSelection
...
class FakeInterestsRepository : InterestsRepository {
    ...
    override suspend fun togglePublicationsSelected(publication: String) {
        mutex.withLock {
    ...
    override fun observeTopicSelected(): Flow<Set<TopicSelection>> = selectedTopics
